...
- Implemented api_user_key validation to check and see if they key given is valid and if it isn't, allow the user to make a key/new key. And if the user can't make a new key/log in to pastebin, polylock will just post/paste as guest.
__ __
